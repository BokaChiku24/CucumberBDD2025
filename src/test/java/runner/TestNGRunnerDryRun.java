...
@CucumberOptions(features = "src/test/resources/features",
                 ...
                 dryRun = true, // This option is used to check if the step definitions are missing or not
...
public class TestNGRunnerDryRun extends AbstractTestNGCucumberTests {
